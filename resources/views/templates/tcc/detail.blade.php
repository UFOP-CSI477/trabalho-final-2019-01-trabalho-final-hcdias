@extends('adminlte::page')
    ...
    <div class="row">
      <section class="content col-lg-6 connectedSortable ui-sortable">
        <!-- <div class="col-md-6"> -->
            ...
            <div class="box-body no-padding">
              <ul class="users-list clearfix">
                @foreach($professoresBanca as $professorBanca)
                  <li>
                    <img src="/media/mario.png">
                    <a href="#" class="users-list-name">{{$professorBanca->nome}}</a>
                    ...
                    <span class="users-list-date">{{ $professorBanca->email }}</span>
                  </li>  
                @endforeach
              </ul>
            </div>
